...
public interface SimpleSimulatorAsync {
	...
	void sendCommands( int playerNumber, Queue<Command> commandQueue, AsyncCallback<CommandPacket> callback);
	
	void startSimulation(AsyncCallback<String> callback);
	
	void getGame(int playerNumber, int lastTurnReceived, AsyncCallback<GameModel> callback);
