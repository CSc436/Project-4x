...
public class UnitStats {
	...
	/**
	 * UnitStats():
	 * @param damage - how much damage unit does
	 * @param range - attack range NOT LOS. 
	 * @param armor - armor defense, impedes attacks
	 * @param health_regen - how quickly they can regenerate health (i.e. how much health is generated per turn
	 * @param health - the current health of this unit 
	 * @param movementSpeed - how quickly this unit can move 
	 * @param actionSpeed - how quickly they action
	 */
